...
.news_table{border-top:3px solid #676665;}
.news_table th,
.news_table td{
...
#bo_list .news_table td{
	text-align:left;
}
#bo_list .news_table td a{
	padding-left:20px;
}
#bo_list .news_table th:first-child,
#bo_list .news_table td:first-child{
	border-right:3px solid #e0e0df;
	text-align:center;
}
#bo_list .news_table tr:last-child td{
