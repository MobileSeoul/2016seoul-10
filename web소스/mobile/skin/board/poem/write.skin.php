...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<?php if ($is_category) { ?>
        <tr>
            <th scope="row"><label for="ca_name">테마구분<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            ...
            <td>
                <select class="required" id="wr_1" name="wr_1" required>
                    <option value="">선택하세요</option>
					<?php
					for($i=1;$i<=9;$i++){
					?>
                    <option value="<?php echo $i?>" <?php echo ($write['wr_1'] == $i)?'selected':'';?>><?php echo $i?>호선</option>
					<?php }?>
                </select>
                <select class="required" id="wr_2" name="wr_2" data-selected="<?php echo $write['wr_2']?>" required>
                    <option value="">선택하세요</option>
                </select>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" id="bf_file_del<?php echo $i ?>" name="bf_file_del[0]" value="1"> <label for="bf_file_del<?php echo $i ?>"><?php echo $file[0]['source'].'('.$file[0]['size'].')'; ?> 파일 삭제</label>
                <?php } ?>
            </td>
        </tr>
