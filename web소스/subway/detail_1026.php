...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
		...
		<div class="fott">
			<ul>
			<!--<li><a href="<?php echo $good_href?>" class="btn_m1">좋아요 <?php echo $view['wr_good']?></a></li>-->
			<!--<li><a  href="./comment.php?comment_url=<?php echo urlencode("http://webox.kr".$_SERVER['REQUEST_URI'])?>&wr_id=<?=$wr_id?>" target="_blank" class="btn_m1">댓글달기 <span class="fb-comments-count" data-href="http://webox.kr<?php echo $_SERVER['REQUEST_URI']?>">0</span></a></li>-->
			<li><a href="javascript:;"> 찜하기</a></li>
			<li><a id="kakao-link-btn" data-id="<?=$wr_id?>" class="btn_m1" href="javascript:;"> 카톡공유 </a></li>
